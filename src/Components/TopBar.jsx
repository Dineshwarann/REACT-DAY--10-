        ...
        <div className="top-bar-section">
               {/* top bar section imported from daisyui */}
                ...
                <div className="flex-1 ">
                    <a className="btn btn-ghost text-xl px-10 " onClick={()=>navigate("/")}>EMPLOYEE CARD PORTAL</a>
                </div>
                <div className="flex-none lg:flex-col gap-2">
                    <a className="btn btn-ghost text-xl px-10 " onClick={()=>navigate("/add")}>ADD EMPLOYEE CARD</a>
